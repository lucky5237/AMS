...
@interface User_Onrspqryproduct : BaseResponseModel
...
@property(nonatomic,strong) NSNumber *CloseDealType;//平仓处理类型    '0'->正常;'1'->投机平仓优先;
@property(nonatomic,copy) NSString *TradeCurrencyID;//交易币种类型
@property(nonatomic,strong) NSNumber *MortgageFundUseRange;//质押资金可用范围    '0'->不能使用;'1'->用于保证金;'2'->用于手续费、盈亏、保证金;
