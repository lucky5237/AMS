...
@interface User_Onrspqrytrade : BaseResponseModel
...
@property(nonatomic,strong) NSNumber *TradingRole;//交易角色    '1'->代理;'2'->自营;'3'->做市商;
...
@property(nonatomic,strong) NSNumber *PriceSource;//成交价来源    '0'->前成交价;'1'->买委托价;'2'->卖委托价;
...
@property(nonatomic,strong) NSNumber *TradeSource;//成交来源    '0'->来自交易所普通回报;'1'->来自查询;
