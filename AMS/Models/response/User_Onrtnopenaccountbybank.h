...
@interface User_Onrtnopenaccountbybank : BaseResponseModel
...
@property(nonatomic,strong) NSNumber *Gender;//性别    '0'->未知状态;'1'->男;'2'->女;
...
@property(nonatomic,strong) NSNumber *MoneyAccountStatus;//资金账户状态    '0'->正常;'1'->销户;
...
@property(nonatomic,strong) NSNumber *CashExchangeCode;//汇钞标志    '1'->汇;'2'->钞;
