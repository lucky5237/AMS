...
@interface User_Onrspfromfuturetobankbyfuture : BaseResponseModel
...
@property(nonatomic,strong) NSNumber *LastFragment;//最后分片标志    '0'->是最后分片;'1'->不是最后分片;
...
@property(nonatomic,strong) NSNumber *CustType;//客户类型    '0'->自然人;'1'->机构户;
...
@property(nonatomic,strong) NSNumber *VerifyCertNoFlag;//验证客户证件号码标志    '0'->是;'1'->否;
@property(nonatomic,copy) NSString *CurrencyID;//币种代码
@property(nonatomic,strong) NSNumber *TradeAmount;//转帐金额
@property(nonatomic,strong) NSNumber *FutureFetchAmount;//期货可取金额
@property(nonatomic,strong) NSNumber *FeePayFlag;//费用支付标志    '0'->由受益方支付费用;'1'->由发送方支付费用;'2'->由发送方支付发起的费用，受益方支付接受的费用;
...
@property(nonatomic,strong) NSNumber *BankSecuAccType;//期货单位帐号类型    '1'->银行存折;'2'->储蓄卡;'3'->信用卡;
@property(nonatomic,copy) NSString *BrokerIDByBank;//期货公司银行编码
@property(nonatomic,copy) NSString *BankSecuAcc;//期货单位帐号
@property(nonatomic,strong) NSNumber *BankPwdFlag;//银行密码标志    '0'->不核对;'1'->明文核对;'2'->密文核对;
@property(nonatomic,strong) NSNumber *SecuPwdFlag;//期货资金密码核对标志    '0'->不核对;'1'->明文核对;'2'->密文核对;
...
@property(nonatomic,strong) NSNumber *TransferStatus;//转账交易状态    '0'->正常;'1'->被冲正;
